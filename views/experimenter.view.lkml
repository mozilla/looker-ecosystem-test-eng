view: experimenter {
  derived_table: {
    sql:
      ...
      FROM `test_metrics.experimenter_suite_results` sub_r
      ...
      FROM `test_metrics.experimenter_suite_results` r
  ...
  dimension: is_last_quarter_date {
    ...
    sql: ${timestamp_raw} = (
          ...
          FROM `test_metrics.experimenter_suite_results`
          WHERE
            `Workflow` = ${workflow}
